...
<nav class="bg-white shadow-lg fixed top-0 z-50 w-full">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex items-center justify-center flex-1">
                <div class="flex space-x-4">
                    ...
                    <a href="{{ route('myfile') }}"
                        class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Files</a>
                    <a href="{{ route('upload') }}"
                        class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Upload</a>
                ...
                <div class="hidden md:flex items-center">
                    <div class="relative">
                        <button id="profileButton"
                            ...
                            <span class="ml-2">{{ $user_login['u_fullname'] }}</span>
                            <svg class="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @else
                <div class="hidden md:flex items-center space-x-3">
                    ...
                    <a href="{{ route('register') }}"
                        class="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">Register</a>
                </div>
            @endif
            <!-- Mobile menu button -->
    ...
    <div id="mobileMenu" class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
            <a href="{{ route('home') }}"
                class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">Home</a>
            <a href="{{ route('myfile') }}"
                class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">Files</a>
            <a href="{{ route('upload') }}"
                class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">Upload</a>
            ...
            @if (isset($user_login['u_id']))
                <div class="border-t border-gray-200 pt-4">
                    <button id="mobileProfileButton"
                        class="w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                        <div class="flex items-center">

                            <span
                                class="ml-3 text-base font-medium text-gray-700">{{ $user_login['u_fullname'] }}</span>
                        </div>
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    $(document).ready(function() {
        ...
        $('#desktopServicesButton').click(function(e) {
            ...
            $('#desktopProductsDropdown, #desktopResourcesDropdown, #profileDropdown').addClass(
                'hidden');
        });
        ...
        $('#desktopProductsButton').click(function(e) {
            ...
            // Close other desktop dropdowns
            $('#desktopServicesDropdown, #desktopResourcesDropdown, #profileDropdown').addClass(
                'hidden');
        });
        ...
        $('#profileButton').click(function(e) {
            ...
            $('#desktopServicesDropdown, #desktopProductsDropdown, #desktopResourcesDropdown').addClass(
                'hidden');
        });
        ...
        $('#mobileServicesButton').click(function() {
            ...
            $('#mobileProductsDropdown, #mobileResourcesDropdown, #mobileProfileDropdown').addClass(
                'hidden');
        });
        ...
        $('#mobileProductsButton').click(function() {
            ...
            // Close other mobile dropdowns
            $('#mobileServicesDropdown, #mobileResourcesDropdown, #mobileProfileDropdown').addClass(
                'hidden');
        });
        ...
        $('#mobileResourcesButton').click(function() {
            ...
            // Close other mobile dropdowns
            $('#mobileServicesDropdown, #mobileProductsDropdown, #mobileProfileDropdown').addClass(
                'hidden');
        });
        ...
        $('#mobileProfileButton').click(function() {
            ...
            // Close other mobile dropdowns
            $('#mobileServicesDropdown, #mobileProductsDropdown, #mobileResourcesDropdown').addClass(
                'hidden');
        });

        // Close all dropdowns when clicking outside
        $(document).click(function() {
            $('#desktopServicesDropdown, #desktopProductsDropdown, #desktopResourcesDropdown, #profileDropdown')
                .addClass('hidden');
        });
