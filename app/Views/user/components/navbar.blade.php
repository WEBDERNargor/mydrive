...
<nav class="bg-white shadow-lg fixed top-0 z-50 w-full">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex items-center justify-center flex-1">
                <div class="flex space-x-4">
                    ...
                    <a href="{{route('myfile')}}" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Files</a>
    ...
    <div id="mobileMenu" class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{route('myfile')}}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">Files</a>
            ...
            <div class="border-t border-gray-200 pt-4">
                <button id="mobileProfileButton" class="w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                    <div class="flex items-center">
                        <img class="h-8 w-8 rounded-full" src="https://picsum.photos/300/300" alt="Profile">
                        <span class="ml-3 text-base font-medium text-gray-700">{{ $user_login['u_fullname'] }}</span>
                    </div>
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                ...
                <div id="mobileProfileDropdown" class="hidden mt-3 space-y-1">
                    <a href="{{route('profile')}}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">Your Profile</a>
